    ...
    static ProjectsData()
    {
        ProjectsList.AddRange(new List<ProjectModel>
        {
            new ProjectModel()
            {
                ...
                {
                    Technology.Html5, Technology.CSS3, Technology.Bootstrap5, Technology.JavaScript, Technology.CSharp,
                    Technology.EntityFramework, Technology.PostgreSQL, Technology.MVC, Technology.Git
                },
                IsLeadProject = true,
            },
            new ProjectModel()
            {
                ...
                Abstract = "<p>The Blog app is a classic blog application built using .NET MVC.</p>" +
                ...
                CardImage = "images/projects/project-4.jpg",
                CarouselImages =
                    new List<string>() { "images/projects/project-4.jpg", "images/projects/project-4.jpg" },
                Technologies = new List<Technology>()
                {
                    Technology.Html5, Technology.CSS3, Technology.Bootstrap5, Technology.JavaScript, Technology.CSharp,
                    Technology.EntityFramework, Technology.PostgreSQL, Technology.MVC, Technology.Git
            ...
            new ProjectModel()
            {
                ...
                Abstract = "<p>The Loan Unicorn app is a small Javascript loan calculator.</p>" +
                           "<p>The app takes user input needed for loan and calculates payment schedule.</p>",

                Description = "<p>The Loan Unicorn app is a small Javascript loan calculator.</p>" +
                              "<p>The app takes user input needed for loan and calculates payment schedule.</p>",
