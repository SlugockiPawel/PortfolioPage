    ...
    static ProjectsData()
    {
        ProjectsList.AddRange(new List<ProjectModel>
        {
            ...
            new ProjectModel()
            {
                ...
                IsMainProject = false,
                Title = "FizzBuzz",
                Abstract = "This is some abstract for now for FizzBuzz. Update it later",
                Description = "This is broader description for FizzBuzz. Update it later.",
                Date = new DateOnly(2022, 02, 13),
                GithubUrl = "https://fizz.com",
                ProjectUrl = "https://www.slugocki.dev",
